...
public class VrmlStudioGroupApplication
{
    public static void main(String[] args)
    {
        SpringApplication.run(VrmlStudioGroupApplication.class, args);
        System.out.println("(♥◠‿◠)ﾉﾞ  Group模块启动成功   ლ(´ڡ`ლ)ﾞ  \n" +
                " .-------.       ____     __        \n" +
                " |  _ _   \\      \\   \\   /  /    \n" +
                " | ( ' )  |       \\  _. /  '       \n" +
                " |(_ o _) /        _( )_ .'         \n" +
